...
type Querier interface {
	...
	GetSplitsByUserFiltered(ctx context.Context, arg GetSplitsByUserFilteredParams) ([]Split, error)
	...
	ListSplitsByUserGroups(ctx context.Context, arg ListSplitsByUserGroupsParams) ([]Split, error)
